...
/* ratings
Эта таблица содержит индивидуальные оценки пользователей фильмов в наборах.

* userId -- запутанные идентификаторы пользователей
* movieId -- идентификатор фильма MovieLens для фильма
* rating     -- рейтинг фильма, предоставленный пользователем
*/

/*
links
В таблице содержатся идентификаторы, 
которые можно использовать для связи с другими источниками данных фильмов. 
Каждая строка этого файла после строки заголовка представляет один фильм 
и имеет следующий формат:
movieId — это идентификатор фильмов, используемый https://movielens.org .
imdbId — это идентификатор фильмов, используемый http://www.imdb.com .  
tmdbId — это идентификатор фильмов, используемый https://www.themoviedb.org . 
*/

/* movies
Информация о фильме содержится в movies. 
Каждая строка представляет один фильм и имеет следующий формат:
ID, это идентификатор фильмов
BUDGET,  бюджет фильма
IMDB_ID, это идентификатор фильмов, используемый www.imdb.com
...
VOTE_AVERAGE, средний рейтинг по 10-ти бальной шкале
VOTE_COUNT, количество оценок
 HOMEPAGE, ссылка на интенет страницу
 OVERVIEW описание
*/
